...
5. Add a flash button entry in [`docs/index.md`](docs/index.md) and a
   wiring page under `docs/boards/` (copy an existing one as a
   template). Save the manufacturer's pinout image into
   `docs/boards/img/` with attribution in the page's `<figcaption>`.
